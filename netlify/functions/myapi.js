...
<body class="bg-gray-50 dark:bg-gray-900">
  ...
  <script type="text/babel">
    ...
    const MENU_DECODER_API_URL = '/.netlify/functions/menu-decoder';
...
1. IDENTIFY QUESTION TYPE FIRST:
   - INJURY/PAIN → Focus on recovery, rest, medical advice
   - EXERCISE → Focus on form, progression, alternatives
   - NUTRITION → Focus on macros, meal timing, food choices
   - GENERAL HEALTH → Focus on lifestyle, habits, wellness
...
• Activity: ${dailyIntake.activity}/${goals.activity}min (${((dailyIntake.activity / goals.activity) * 100).toFixed(0)}%)
• Water: ${dailyIntake.water}/${goals.water} glasses (${((dailyIntake.water / goals.water) * 100).toFixed(0)}%)
